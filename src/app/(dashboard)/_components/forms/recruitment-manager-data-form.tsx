...
export function RecruitmentManagerDataForm() {
  ...
  const addMonthlyData = api.recruitmentManager.addMonthlyData.useMutation({
    onSuccess: (res) => {
    ...
    try {
      ...
      addMonthlyData.mutate({
        invoices: invoiceRows.map((invoice) => ({
          ...
          managerName: invoice["Recruitment managerName"],
          managerEmail: invoice["Recruitment Manager Email"].toLowerCase(),
